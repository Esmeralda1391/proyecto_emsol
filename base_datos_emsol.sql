...
--
-- Dumping routines for database 'emsol'
--
/*!50003 DROP PROCEDURE IF EXISTS `EM_BUSCAR_USUARIO` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `EM_BUSCAR_USUARIO`(correo varchar(50), contra varchar(150))
begin

    select * from usuarios_credenciales where email = correo and password = contra;
...
-- Dump completed on 2023-12-04 23:18:00
